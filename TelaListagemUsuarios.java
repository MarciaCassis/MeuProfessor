...
public class TelaListagemUsuarios {
    ...
    TextView txtnome, txtemail, txttelefone, txtdisciplina, txtstatus;

    int index;

    public TelaListagemUsuarios(MainActivityTelaPrincipal act,TelaPrincipal tela_principal) {
...
//inseridos
        ...
        txtemail = (TextView) act.findViewById(R.id.txtemail);
        txttelefone = (TextView) act.findViewById(R.id.txttelefone);
        txtdisciplina = (TextView) act.findViewById(R.id.eddisciplina);
    ...
    private void PreencheCampos(int idx)
    {
        ...
        txtemail.setText(act.getRegistros().get(idx).getEmail());
        txttelefone.setText(act.getRegistros().get(idx).getTelefone());
        txtdisciplina.setText(act.getRegistros().get(idx).getDisciplina());
    }
